...
def read_root():
    return JSONResponse(content={"message": "🚀 FastAPI con SSL y BD lista. Energizado por EasyEngine con Docker y Nginx integrados. Alojado en Vultr."}, media_type="application/json")
